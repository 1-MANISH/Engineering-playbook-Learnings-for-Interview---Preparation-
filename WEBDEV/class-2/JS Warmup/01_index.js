...
function sum(a,b,resultCallback){
        let res =  a+b;
        if(resultCallback){
                resultCallback(res);
                return;
...
function displayResult(data){console.log(`Result of the sum function is: ${data}`);}

function displayResultPassive(data){console.log(`The sum function result  is: ${data}`);}
...
// sum(20,30,displayResultPassive);


// setTimeout

// console.log("Start of JS Warmup Topics");

// function greetUser(name){
//         console.log(`Hello, ${name}! Welcome to the JS Warmup session.`);
// }
// setTimeout(()=>{
...
// console.log("End of JS Warmup Topics");
